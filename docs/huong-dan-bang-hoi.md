...
Cập nhật: 2026-08-05 · Lối chơi tổng: [`loi-choi.md`](loi-choi.md) · Config/ops: [`plugins/CorePlugin/gang/README.md`](../plugins/CorePlugin/gang/README.md)
...
Chi tiết ops/region: [`world-pvp-safezone-notes.md`](world-pvp-safezone-notes.md).
...
- Paste Discord: [`huong-dan-bang-hoi-discord.md`](huong-dan-bang-hoi-discord.md)
