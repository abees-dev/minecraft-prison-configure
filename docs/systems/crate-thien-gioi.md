# Hòm Thiên Giới — Point shop, pity và NPC đổi

Cập nhật: 2026-07-30 (refactor weight). Give nhanh: [`give-thien-gioi.md`](../reference/give-thien-gioi.md) · Mục lục: [`INDEX.md`](../INDEX.md).
...
- Plan crate khác: [`crates-refactor.md`](../archive/crates-refactor.md)
