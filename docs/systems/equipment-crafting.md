# Trang bị, tinh luyện và nâng cấp (MMOItems 9 rank)

> Trạng thái: **Live** · Lối chơi tổng: [`gameplay.md`](../player/gameplay.md) · Mục lục: [`INDEX.md`](../INDEX.md) · Bảng số cuốc: [`pickaxe-upgrades.md`](pickaxe-upgrades.md)
...
Chi tiết: [`npc-weapon-forges.md`](../admin/npc-weapon-forges.md).
...
* 📁 **[`plugins/MMOItems/scripts/generate_weapons.js`](../../plugins/MMOItems/scripts/generate_weapons.js)**

### 🚀 Cách sử dụng:
Nếu bạn muốn chỉnh sửa lại công thức tính sát thương / cấp độ vũ khí toàn bộ 135 vật phẩm (Kiếm, Rìu Chiến, Trượng Phép):
1. Mở file [`generate_weapons.js`](../../plugins/MMOItems/scripts/generate_weapons.js) và thay đổi công thức chỉ số trong các hàm `getSwordStats`, `getAxeStats`, `getStaffStats`.
