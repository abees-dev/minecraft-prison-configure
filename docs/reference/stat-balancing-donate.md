# Cân bằng chỉ số và thiết kế item Donate/Gacha

> F2P chuẩn: [`../STAT_BALANCING_STANDARD.md`](../../STAT_BALANCING_STANDARD.md) · Lối chơi: [`gameplay.md`](../player/gameplay.md) · Mục lục: [`INDEX.md`](../INDEX.md)
...
Xem tài liệu hướng dẫn quy chuẩn viết tắt và mã màu hiển thị chi tiết tại: [`stat-abbreviations.md`](stat-abbreviations.md).

---

## 📑 7. PHÂN LOẠI CHI TIẾT ĐỒ DONATE VS FREE VS TRADE
Xem tài liệu phân loại chi tiết 15 bộ trang sức và đồ Donate / Free tại: [`item-classification.md`](item-classification.md).
