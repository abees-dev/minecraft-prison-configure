# Give — Hòm Thiên Giới (pool)

Weight/docs: [`crate-thien-gioi.md`](../systems/crate-thien-gioi.md). Đổi `Abeess` = tên player. Không có `/`.

## Key / pity

```
crates key give Abeess chia_khoa_thien_gioi 1
crates key give Abeess chia_khoa_ruong_ngoc 1
mmoitems give MATERIAL MANH_THIEN_GIOI Abeess 1
```
