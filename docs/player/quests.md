...
Cập nhật: 2026-07-31. Lối chơi: [`gameplay.md`](gameplay.md) §6.2 A (cá nhân) — **cùng tồn tại** với quest Bang Hội §6.2 A2 (`/gang quest`). Config runtime: `plugins/CorePlugin/dailyquest/`.
